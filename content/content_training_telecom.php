        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
              <div class="text-left">
				...
				<li style="text-decoration:none;padding-bottom:10px;"><a  href="#telecomSubmenu1" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"href="../content/telephony/ACD_Basics.pdf" class="btn btn-info btn-sm" style="color:white;">Ver</a>  Automatic Call Distribution (ACD) Basics </li>
