        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
              <div class="text-left">
				...
				<a  class="btn btn-danger btn-sm " href="../../files/tollFree/tollfreenewaudios.rar" target="_blank" style="color:white;background-color:#C26861;width:200px;">Get Recordings for the IVR </a>
