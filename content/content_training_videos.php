...
foreach ($permissions as $p_id) 
	...
	if ($permissionname != NULL) {
		if ($permissionname == "training"){
			header('Location: https://certiustech.sharepoint.com/sites/KnowledgeDatabase/Documentos%20compartidos/Forms/AllItems.aspx?viewid=0ecd27b9%2D99be%2D4dbe%2Da1a3%2D874d70e7b535&id=%2Fsites%2FKnowledgeDatabase%2FDocumentos%20compartidos%2FKT%2DSessions%2FInternal%20Training%20KTs');
exit;
		/* echo '	
			...
			<div class="text-left">
				<ul style="list-style:none">
					...
					<li style="text-decoration:none;padding-bottom:10px; "><a  href="#trainingVidSubmenu16" data-toggle="collapse" aria-expanded="false" class="btn btn-info btn-sm"  style="color:white;background-color:#825EAB;">Ver </a>
						Security Assessment parte 2
							<div class="collapse list-unstyled" id="trainingVidSubmenu16">
								<h3 class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms">Security Assessment P.2</h3>
								
									<video width="75%" height="450px"  controls>
									  <source src="../files/training/securityAssesmentPart2.mp4" type="video/mp4">
									Your browser does not support the video tag.
									</video>
							</div>
					</li>
						...
						Conflictos en nombres de archivos Windows vs. Linux
							<div class="collapse list-unstyled" id="trainingVidSubmenu17">
								<h3 class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms">OS Naming Conventions</h3>
									...
									<video width="75%" height="450px"  controls>
									  <source src="../files/training/namingConventions.mp4" type="video/mp4">
									Your browser does not support the video tag.
									</video>
							</div>
					</li>
					...
					<li style="text-decoration:none;padding-bottom:10px; "><a  href="#trainingVidSubmenu19" data-toggle="collapse" aria-expanded="false" class="btn btn-info btn-sm"  style="color:white;background-color:#825EAB;">Ver </a>
						Maven, Nexus y Bamboo
							<div class="collapse list-unstyled" id="trainingVidSubmenu19">
								<h3 class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms">Maven Nexux y Bamboo</h3>
								
									<video width="75%" height="450px"  controls>
									  <source src="../files/training/mavenNexusBamboo.mp4" type="video/mp4">
									Your browser does not support the video tag.
									</video>
							</div>
					</li>
					...
					<li style="text-decoration:none;padding-bottom:10px; "><a  href="#trainingVidSubmenu24" data-toggle="collapse" aria-expanded="false" class="btn btn-info btn-sm"  style="color:white;background-color:#825EAB;">Ver </a>
						Arquitectura VoIP SiP Vs. H.323 c/AES
							<div class="collapse list-unstyled" id="trainingVidSubmenu24">
								<h3 class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms">SiP / H323</h3>
								
									<video width="75%" height="450px"  controls>
									  <source src="../files/training/sipH323aes.mp4" type="video/mp4">
									Your browser does not support the video tag.
									</video>
							</div>
					</li>
					...
					<li style="text-decoration:none;padding-bottom:10px; "><a  href="#trainingVidSubmenu25" data-toggle="collapse" aria-expanded="false" class="btn btn-info btn-sm"  style="color:white;background-color:#825EAB;">Ver </a>
						Bases de Datos Oracle Grandes Clientes
							<div class="collapse list-unstyled" id="trainingVidSubmenu25">
								<h3 class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms">Nuestra experiencia con Telef&oacute;nica</h3>
					...
					<li style="text-decoration:none;padding-bottom:10px; "><a  href="#trainingVidSubmenu27" data-toggle="collapse" aria-expanded="false" class="btn btn-info btn-sm"  style="color:white;background-color:#825EAB;">Ver </a>
						Maven and Spring Inyecci&oacute;n de Dependencias 
							<div class="collapse list-unstyled" id="trainingVidSubmenu27">
								<h3 class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms">Maven Spring</h3>
								
									<video width="75%" height="450px"  controls>
									  <source src="../files/training/mavenSpringManejoDependencias.mp4" type="video/mp4">
									Your browser does not support the video tag.
									</video>
							</div>
					</li>
					
					<li style="text-decoration:none;padding-bottom:10px; "><a  href="#trainingVidSubmenu28" data-toggle="collapse" aria-expanded="false" class="btn btn-info btn-sm"  style="color:white;background-color:#825EAB;">Ver </a>
						Interfaces Java y Rest Template
							<div class="collapse list-unstyled" id="trainingVidSubmenu28">
								<h3 class="wow zoomIn" data-wow-duration="1000ms" data-wow-delay="100ms">Maven Spring</h3>
								
									<video width="75%" height="450px"  controls>
									  <source src="../files/training/interfacesyRestTemplate.mp4" type="video/mp4">
									Your browser does not support the video tag.
									</video>
							</div>
					</li>
